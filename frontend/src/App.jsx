...
function TravelGraph({ graphData, selected }) {
  ...
  if (!mainDestination) {
    return (
      <div className="graph-message">
        ...
        <p>
          Select a destination and click Explore.
        </p>
      </div>
    );
  }
  ...
  // ---------------------------------------------------
  // Find ONLY connections related to selected node
  // ---------------------------------------------------
  ...
  links.forEach((link) => {
    ...
    if (target.id === mainDestination.id) {
      otherNode = source;
    }
  ...
  relatedConnections.forEach(
    (connection) => {
      ...
      const key =
        `${connection.node.id}-${connection.relationship}`;
  ...
  const destinationConnections =
    uniqueConnections.filter(
      (connection) =>
        connection.node.type === "Destination"
    );

  const attractionConnections =
    uniqueConnections.filter(
      (connection) =>
        connection.node.type === "Attraction"
    );

  const interestConnections =
    uniqueConnections.filter(
      (connection) =>
        connection.node.type === "Interest"
    );
  ...
  const NodeCard = ({
    ...
    return (
      <div
        className={
          `travel-node ${getClass(node.type)} ` +
          `${main ? "main-node" : ""}`
        }
      >
    ...
    <div className="clean-graph">
      ...
      <div className="graph-top">
        ...
        <div>
          ...
          <p>
            Explore connections around this destination
          </p>
      ...
      <div className="graph-layout">
        ...
        <div className="graph-column left-column">
          ...
          <div className="column-title">
            ...
            <span className="column-icon purple">
              📍
            </span>
        ...
        <div className="graph-column right-column">
          ...
          <div className="column-title">
            ...
            <span className="column-icon blue">
              🏛
            </span>
          ...
          <div className="column-title interests-title">
            ...
            <span className="column-icon green">
              ★
            </span>
